\begin{section}{Skills}
  \begin{tabularx}{\linewidth}{@{}l X@{}}
    ...
    \textbf{Technologies} &\small{Nodejs, React, HTML, CSS, Git, Docker, SQL, GraphQL using Apollo framework, iOS, SwiftUI, Make, Jest test runner, React Testing Library, E2E testing with Cypress/Playwright, Wiremock, Pact consumer-driven contract testing, Gatling performance tests, Elasticsearch/Kibana, Prometheus/Grafana/StatsD.} \\
